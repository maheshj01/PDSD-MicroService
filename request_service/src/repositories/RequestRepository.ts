...
class RequestRepository {
    ...
    static async storeRequest(user_id: number, book_title: string, book_author: string, justification: string): Promise<Request> {
    ...
    static async getRequestHistory(): Promise<Request[]> {
